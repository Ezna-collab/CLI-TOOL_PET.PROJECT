...
A command-line file manager built with Python, following **Clean Architecture** principles. It allows you to create, read, edit, rename,delete,list files directly from your terminal.
...
### create fie
Files  are created into predefined folders based on their extension:
...
- **Interface adapters** — File system operations
